...
public class ToDoTouchHelperCallBack  extends ItemTouchHelper.Callback{

    ToDoListRVAdapter mAdapter;

    public ToDoTouchHelperCallBack(ToDoListRVAdapter adapter) {
        mAdapter = adapter;
    }
    @Override
